...
\033[1;92m   |Author:  𝙴𝚅𝙰𝙽 𝙰𝙷𝙼𝙰𝙳 𝙼𝙰𝙷𝙵𝚄𝚉 𝙱𝚁𝙾𝚃𝙷𝙰𝚁 𝚂𝚀𝚆𝙰𝚁𝙳            |

\033[1;93m   |                                           |

\033[1;93m   |Github:  https://github.comevan.ahmad/786|

\033[1;93m   |                                           |

\033[1;93m   |Youtube:   𝙴𝚅𝙰𝙽 𝙰𝙷𝙼𝙰𝙳 𝚃𝙲𝙻         |
...
\033[1;93m       | |_) | __ _ _ __   __ _| | __ _ 
...
while loop == 'true':
    ...
    if (CodeWord == CorrectCodeWord):
        ...
        jalan('    \x1b[1;97m•◈•◈•◈•◈• Welcome To EVAN Tool •◈•◈•◈•◈•')
...
def pilih_login():
    ...
    if peak == '':
        ...
        os.system('xdg-open https://youtube.com/channel/UC79rCF6je42UEiXQhaxUHzA')
...
def automatic():
    ...
    print '\x1b[1;95m◈◈◈◈◈◈◈◈◈◈◈ Developed By EVAN AHMAD MAHFUZ ◈◈◈◈◈◈◈◈◈◈◈ '
